# WKT12 Advanced Exit Node Guide, with:
...
Ping Results:  A correct setup should yield an average latency between 0.3 and 1.0 ms, with a minimum of 0.2 ms and a maximum of less than 2 ms. Most importantly, there should be 0% packet loss to ensure a stable connection.
